# Welcome to the Elastic APM Server 7.7.1
...
[Getting started](https://www.elastic.co/guide/en/apm/get-started/7.7/) guide.

## Documentation

Visit [Elastic.co Docs](https://www.elastic.co/guide/en/apm/server/7.7/)
